...
function is_logged_in() { return isset($_SESSION['member_id']); }
function has_role($roles) { if (!isset($_SESSION['role'])) return false; if (!is_array($roles)) $roles = [$roles]; return in_array($_SESSION['role'], $roles); }
